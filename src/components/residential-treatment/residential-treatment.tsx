...
const Residential = () => {
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 text-sm">
        <h1
          id="residential-treatment-heading"
          className="text-4xl font-bold text-[#0097b2] mb-6"
        >
          Residential Treatment
        </h1>

        <section aria-labelledby="residential-treatment-heading">
          <p className="text-gray-700 leading-relaxed mb-4">
            Three Rivers Residential Treatment Program provides comprehensive
            residential care for adults with behavioral, emotional, or
            psychiatric challenges. The program is designed for adults aged 18
            and older and offers a variety of evidence-based therapies tailored
            to each individual's needs.
          </p>

          <h2
            id="key-components-heading"
            className="text-xl font-bold text-[#0097b2] mb-2"
          >
            Key Components of the Program:
          </h2>
          <ul
            className="list-disc list-inside text-gray-700 mb-6 space-y-1"
            aria-labelledby="key-components-heading"
          >
            <li>
            ...
            <li>
              ...
              developed based on the assessment, incorporating various
              therapeutic modalities and interventions.
            </li>
            <li>
              Flexible Therapies: A range of evidence-based therapies, such as
              Dialectical Behavior Therapy (DBT) and Eye Movement
              Desensitization and Reprocessing Therapy (EMDR) Phases 1 and 2
              interventions, are employed to address specific needs.
            </li>
            <li>
              ...
              Cognitive Behavioral Therapy (TF-CBT), work with individuals to
              help them process and heal from traumatic experiences.
            </li>
            <li>
              ...
              training, and recreational therapy to support healing and
              recovery.
            </li>
            <li>
          ...
          <ul
            className="list-disc list-inside text-gray-700 mb-6 space-y-1"
            aria-labelledby="areas-specialty-heading"
          >
          ...
          <h2
            id="treatment-modalities-heading"
            className="text-xl font-bold text-[#0097b2] mb-2"
          >
          ...
          <ul
            className="list-disc list-inside text-gray-700 mb-6 space-y-1"
            aria-labelledby="treatment-modalities-heading"
          >
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            fullest potential by offering a safe and supportive environment to
            engage in the regulation of the nervous system in a trauma-focused
            treatment program to promote mind-body integration. By focusing on
            personalized and adaptable strategies, the program aims to offer
            effective and supportive care for individuals with diverse
            experiences.
          </p>
        </section>
      </main>
