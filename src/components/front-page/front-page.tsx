    ...
    <div className="min-h-screen h-full">
      <header className="flex flex-col items-center justify-center mb-16">
        ...
        <img
          ...
          alt="Three Rivers Behavioral Health - Comprehensive psychiatric care facility in West Mifflin, Pennsylvania"
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
            <div>
              <img
                ...
                alt="Healthcare professional providing compassionate psychiatric care and treatment at Three Rivers Behavioral Health"
